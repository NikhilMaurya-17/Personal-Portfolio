     ...
     w-full h-full overflow-hidden backdrop-blur-sm'>
        ...
        animate={{opacity:1,scale:1}}>
            ...
            <div className="p-5">
              ...
              <p className='mb-3 fontt-normal text-neutral-400'>{description}</p>
              {subDescription.map((subDesc,index) => 
                (<p className='mb-3 fontt-normal text-neutral-400'>
                  {subDesc}</p>
                ))}
