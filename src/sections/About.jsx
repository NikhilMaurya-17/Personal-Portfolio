...
const About = () => {
  ...
  return (
    <section className="c-space secion-spacing">
        ...
        <div className="flex items-end grid-default-color grid-1">
          <img src="assets/coding-pov.png" alt="" 
           className="absolute scale-[1.75] -right-[5rem] -top-[1rem] md:scale-[3]
            ...
            <div className=" z-10">
              <p className="headtext">Hi,I'm Nikhil</p>
              <p className="subtext">
                Over the year ,I developed my frontend and backend dev
        ...
        <div className="grid-default-color grid-2">
          <div  ref = {grid2Container}className="flex items-center justify-center
           w-full h-full">
            ...
            text="Design principles" containerRef={grid2Container}/>
             <Card style={{rotate:"20deg",top:"10%",left:"30%"}}
             text="SRP" containerRef={grid2Container}/>
              ...
              image="assets/logos/dotnet-pink.png" containerRef={grid2Container}/> 

              <Card style={{rotate:"-45deg",top:"5%",left:"10%"}}
              image="assets/logos/blazor-pink.png" containerRef={grid2Container}/> 
        ...
        {/* Grid 4 */}
         ...
         <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I am specialize in a variety of languages,Frameworks,and tools that
              allow me to buils robust and scalable applications. 
            </p>
          </div>
